...
```bash
RESULTS_DIR=~/code/playground/stock-price-analyze/results/$(date +%F)
~/.claude/skills/stock-advisor/scripts/.venv/bin/python   ~/.claude/skills/stock-advisor/scripts/report_skeleton_builder.py   --context "$RESULTS_DIR/report_context.json"   -o "$RESULTS_DIR/report.md"
```
...
```bash
~/.claude/skills/stock-advisor/scripts/.venv/bin/python   ~/.claude/skills/stock-advisor/scripts/validate_report.py   --report "$RESULTS_DIR/report.md"   --signals "$RESULTS_DIR/signals.json"   --quant-decisions "$RESULTS_DIR/quant_decisions.json"   --backtest-dir "$RESULTS_DIR/backtest"   --portfolio ~/code/playground/stock-price-analyze/portfolio.yaml
```
